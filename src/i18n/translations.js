/**
 * ForYouPack — Translations (AR / EN)
 * Single source of truth for all bilingual text.
 */

const translations = {
  en: {
    /* Meta */
    pageTitle:         'ForYouPack — The Right Box, At The Right Time | Industrial Packaging',
    ...
    navContact:        'Contact',
    navGetQuote:       'Request a Quote',

    /* Nav dropdown labels */
    navAboutOverview:       'Company Overview',
    navAboutLocation:       'Our Location',
    navProductsSingle:      'Single Wall Boxes',
    navProductsDouble:      'Double Wall Boxes',
    navProductsHeavy:       'Heavy Duty Boxes',
    navProductsDieCut:      'Die-Cut Custom Boxes',
    navIndustriesFood:      'Food Factories',
    navIndustriesWater:     'Mineral Water',
    navIndustriesAgri:      'Agriculture & Fertilizers',
    navIndustriesGlass:     'Glass Factories',
    navIndustriesOil:       'Oil Factories',
    navIndustriesCookware:  'Cookware Factories',
    ...
    quoteSubtitle:     'Fill out the form below and we\'ll respond within 24 hours with a tailored quote for your packaging needs.',
    quoteFormTitle:    'Request a Quote',
    quoteFormSub:      "Send us your requirements and we'll respond within 24 hours with a tailored quote.",
    formName:          'Full Name',
  ...
  ar: {
    /* Meta */
    pageTitle:         'فوريو باك — الصندوق الصح في الوقت الصح | كراتين تغليف صناعية',
    ...
    /* Nav dropdown labels */
    navAboutOverview:       'نبذة عن الشركة',
    navAboutLocation:       'موقعنا',
    navProductsSingle:      'كرتون أحادي الموجة',
    navProductsDouble:      'كرتون مزدوج الموجة',
    navProductsHeavy:       'كرتون صناعي ثقيل',
    navProductsDieCut:      'كرتون مقطوع مخصص',
    navIndustriesFood:      'مصانع الغذاء',
    navIndustriesWater:     'مصانع المياه المعدنية',
    navIndustriesAgri:      'شركات الأسمدة الزراعية',
    navIndustriesGlass:     'مصانع الزجاج',
    navIndustriesOil:       'مصانع الزيوت',
    navIndustriesCookware:  'مصانع أواني الطهي',
    ...
    quoteSubtitle:     'أرسل لنا نموذج الطلب وسنرد عليك خلال 24 ساعة بعرض سعر مخصص لاحتياجاتك من التغليف.',
    quoteFormTitle:    'اطلب عرض سعر',
    quoteFormSub:      'أرسل لنا تفاصيل احتياجاتك وسنتواصل معك خلال 24 ساعة بعرض سعر مخصص.',
